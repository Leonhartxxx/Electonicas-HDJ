...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Tienda Electrónica HDJ</title>
    ...
    <body class="bg-gray-100">
        <header class="bg-blue-800 text-white p-6">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <nav>
                    <a href="#" class="mr-6 hover:text-gray-300">Inicio</a>
                    <a href="#" class="mr-6 hover:text-gray-300">Productos</a>
                    <a href="#" class="hover:text-gray-300">Carrito</a>
                </nav>
            </div>
        </header>
        ...
        <main class="container mx-auto my-6">
            <section class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-4 rounded-lg shadow-md">
                    <img src="https://via.placeholder.com/150" alt="Producto 1" class="w-full h-40 object-cover rounded-md">
                ...
                <!-- Producto 2 -->
                <div class="bg-white p-4 rounded-lg shadow-md">
                    <img src="https://via.placeholder.com/150" alt="Producto 2" class="w-full h-40 object-cover rounded-md">
                ...
                <!-- Producto 3 -->
                <div class="bg-white p-4 rounded-lg shadow-md">
                    <img src="https://via.placeholder.com/150" alt="Producto 3" class="w-full h-40 object-cover rounded-md">
